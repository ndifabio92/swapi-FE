import Alderaan from '../assets/images/planets/Alderaan.png';
...
import Hoth from '../assets/images/planets/Hoth.jpg';
...
import Yavin_IV from '../assets/images/planets/Yavin_IV.jpg';

export const PLANETS: { [key: string]: string } = {
    "Alderaan": Alderaan,
    "Bespin": Bespin,
    "Coruscant": Coruscant,
    "Dagobah": Dagobah,
